...
const Dropdown = ({icon , label , options,htmlFor,id ,name , onChange,defaultOption}) => {
    ...
    <>
      ...
      <div className="flex w-full h-full mt-[6px] bg-white-100 rounded-md">
        <button
          ...
          type="button"
          className="flex justify-between items-center w-full rounded-md border-[1px]  border-gray-200 px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:border-purple-500 focus:border-purple-500"
          id="options-menu"
