...
import {down_arrow as upload_icon} from '../../assets/icon';
...
//     return(<>
//         <div 
//               className="rounded-md bg-whitesmoke box-border max-w-[355px] w-[80px] h-[80px] flex flex-row items-center justify-start py-2 px-6 text-center text-dimgray border-[1px] border-dashed border-darkgray"
//               onDrop={handleDrop}
//               onDragOver={handleDragOver}
//             >
//               <div 
//                   className="max-w-[355px] border-[1px] h-10 w-12 border-gray-100  shrink flex flex-col items-center justify-center gap-[16px]"
//                   onClick={handleUpload}
//               >
//                 <img
//                   className="relative w-6 h-6 overflow-hidden shrink-0"
