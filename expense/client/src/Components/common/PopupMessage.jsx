...
export default function PopupMessage({ message, skipable = true, showPopup, setShowPopup }) {
    ...
    return (
        <>
            {showPopup && (
                <div onClick={handleOutsideClick} className="z-20 fixed overflow-hidden flex justify-center items-center inset-0 backdrop-blur-sm w-full h-full left-0 top-0 bg-gray-800/60 scroll-none">
