...
export default function PopupModal(props){
   ...
   // const skipable = props.skipable || true
    ...
    return(
        <>
            {showModal && <div onClick={handleOutsideClick} className="fixed z-[9999] overflow-hidden flex justify-center items-center inset-0 backdrop-blur-sm w-full h-full left-0 top-0 bg-gray-800/60 scroll-none">
