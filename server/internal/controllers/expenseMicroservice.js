...
export const approveAddALegToExpense = async (changesMade) => {
 const expenseBaseUrl = process.env.EXPENSE_BASE_URL ;
 const extendedUrl = 'approve/addleg';

 const currentTripUrl = `${expenseBaseUrl}${extendedUrl}`;
...
//    };
 ...
 console.log('this is what i sent to expense:',changesMade)
...
export const rejectAddALegToExpense = async (changesMade) => {
    const expenseBaseUrl = process.env.EXPENSE_BASE_URL ;
