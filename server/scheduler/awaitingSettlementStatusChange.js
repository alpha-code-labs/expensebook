...
export async function batchJob(){
    ...
    try {   
            ...
            for (const result of results) {
                // Check if embeddedTravelRequest has a value of 'booked' for travelRequestStatus
                if (result.embeddedTravelRequest.travelRequestStatus === 'booked') {
                // Update the corresponding cashAdvances elements with cashAdvanceStatus 'paid'
