...
// router.post('/:tenantId/updateEmployees', async (req, res) => {
...
//       // Check if the tenant was found and updated successfully
//       if (!updatedTenant) {
//         return res.status(404).json({ error: 'Tenant not found' });
//       }
  
//       // Return the updated tenant
//       return res.json({ message: 'Employees updated successfully', tenant: updatedTenant });
//     } catch (error) {
//       console.error(error);
//       return res.status(500).json({ error: 'Server Error' });
//     }
