...
import {fetchOnboardingData, fetchGroupAndPoliciesData} from '../services/onboardingService.js'
...
const createTravelRequest = async(req, res)=>{
    try{
        ...
        const {tenantId, createdBy, createdFor, travelRequestStatus, travelRequestState, travelAllocationHeaders, itinerary, travelDocuments, approvers, preferences, travelViolations} = req.body
        ...
        const travelAndNonTravelPolicies = await fetchGroupAndPoliciesData(tenantId) 
...
const updateTravelRequest = (req, res)=>{
