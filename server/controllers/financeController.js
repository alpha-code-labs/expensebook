...
const tripFilterSchema = Joi.object({
  ...
  tripStatus: Joi.array()
    .items(Joi.string().valid(...tripStatusEnum))
    .optional(),
  cashAdvanceStatus: Joi.array()
    .items(Joi.string().valid(...cashAdvanceStatusEnum))
    .optional(),
  expenseHeaderStatus: Joi.array()
...
const financeSchema = Joi.object({
  ...
  .without("filterBy", ["fromDate", "toDate"]);
...
export { dataSchema, tripFilterSchema };
