...
const employeeSchema = new mongoose.Schema({
  ...
  travelPreferences: {
    ...
    // },
    // }, removed from  profile as of now
    // nonTravelSettlement:{
    //   paymentMethod: {
    //     type: String,
    //     default:"Salary Account"
...
const companyDetailsSchema = new mongoose.Schema({
  ...
  defaultCurrency: {
    ...
    shortName: String,
    symbol: String,
  }, // default currency symbol is needed or not here
  industry: String,
});
...
const hrCompanySchema = new mongoose.Schema({
  ...
  advanceSettlementOptions: {
    Cash: Boolean,
    Cheque: Boolean,
    ["Salary Account"]: Boolean,
    ["Prepaid Card"]: Boolean,
    ["NEFT Bank Transfer"]: Boolean,
  }, // add options here if its fixed values
