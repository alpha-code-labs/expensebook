...
//   },
//   travelRequestId: {
//     type: process.env.NODE_ENV === 'production' ? mongoose.Schema.Types.ObjectId : String, // Conditionally set the type
//     required: true},
//   travelRequestStatus: {
//     type: String,
...
//         {
//           travelRequest: {
//             type: process.env.NODE_ENV === 'production' ? mongoose.Schema.Types.ObjectId : Object,
//             ref: 'TravelRequest',
//           },
//           cashAdvance: {
//             type: process.env.NODE_ENV === 'production' ? mongoose.Schema.Types.ObjectId : Object,
...
//             type: String,
//             enum: tripStatusEnum,
//             default: 'upcoming', // Initialize with status as 'upcoming'
//             required: true,
//             index: true,
//           },
//           tripStartDate: {
