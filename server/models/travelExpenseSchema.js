...
const expenseLineSchema = new mongoose.Schema(
  {
    ...
    expenseLineAllocation: [
      {
        //Travel expense allocation comes here
        headerName: String,
        headerValues: String,
      },
    ],
...
const travelExpenseSchema = new mongoose.Schema({
  ...
  travelAllocationFlags: {
    //Comes from HRMaster -Based on this expense booking screen changes
    level1: Boolean,
    level2: Boolean,
    level3: Boolean,
  },
  ...
  approvers: [
    // added directly from travel request approvers
    {
      empId: String,
      name: String,
      status: {
...
export { expenseHeaderStatusEnums, travelExpenseSchema };
