 ...
 <ScrollView
   ...
   <View className='flex px-2 mt-2 h-[900px] mb-20'> 
    ...
    <View className='h-full px-2 py-2'>
        ...
        <View className='absolute h-auto z-16  right-2 top-12 bg-white shadow-xl shadow-neutral-800 rounded-[12px] flex item-center justify-center px-4' >
          <Text style={{fontFamily: 'Cabin'}} className='text-neutral-800 font-normal w-full   text-center'>{titleCase(trItem?.expenseRejectionReason ?? "")}</Text>
        </View>
      )}
         </Pressable> 
