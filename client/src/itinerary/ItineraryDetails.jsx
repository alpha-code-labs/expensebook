...
const ItineneryDetails= ({ icon ,airplane ,preferences ,actionBtnText}) => {
  ...
  const SubItinerary = ({titleText ,pickupTime ,pickupAddress ,dropAddress , itineraryId  })=>{
...
//                   <div
//                     className={`flex w-auto items-center px-3 pt-[6px] pb-2 py-3 rounded-[12px] text-[14px] font-medi cursor-pointerum tracking-[0.03em] bg-red-100 text-red-900`}
//                     onClick={() => {handleOpenModal(true),console.log(tripData.departure.itineraryId ,)}}>
//                     {actionBtnText}
...
//           <div
//             className={`flex w-auto items-center px-3 pt-[6px] pb-2 py-3 rounded-[12px] text-[14px] font-medi cursor-pointerum tracking-[0.03em] bg-red-100 text-red-900`}
//             // onClick={() => (console.log(tripData.return.itineraryId))}
//             onClick={()=>{(handleOpenModal2(true))}}
//           >
//             Cancel
//           </div>
//           <Modal
...
//       <div onClick={()=>{(console.log(itineraryId)),handleOpenModal(true)}} className='p-3 bg-slate-100 rounded-full m-4 hover:bg-red-100'>
//             <img src={cancel} alt="double arrow" width={20} height={20} />
//       </div>
//       <Modal
//           isOpen={isModalOpen}
