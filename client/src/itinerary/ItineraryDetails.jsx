...
const ItineneryDetails= ({selectedItineraryIds,handleSelect, icon ,mode ,preferences ,actionBtnText ,routeData , handleOpenOverlay}) => {
          ...
          <div className='Itinenery mb-5' key={index}>
            <div className='h-auto w-auto border-[1px] border-slate-300 bg-slate-50 hover:border-purple-500 rounded-md cursor-pointer'>
              <div className='flex flex-row py-3 px-2 divide-x'>
                  ...
                  <div className='flex items-start justify-start flex-col shrink w-auto md:w-[200px] mr-4'>
                    ...
                    <div className='ml-4 max-w-[200px] w-auto'>
                      <span className='text-xs font-cabin'>
                        <div className='ml-4 max-w-[200px] w-auto'>
                          <span className='text-xs font-cabin'>
                            {formatDate(tripData.bkd_date)}, {tripData.bkd_time}
                          </span>
                        </div>
                      </span>
                    </div>
                ...
                {new Date(tripData.bkd_date) >= new Date()&&  
                ( <div onClick={()=>handleSelect(tripData.itineraryId)}>{selectedItineraryIds.includes(tripData.itineraryId) ? <img src={check_circle} width={20} height={20}/>:<img src={round_circle} width={20} height={20} className="cursor-pointer"/>}</div>
...
// const ItineneryDetails= ({ icon ,mode ,preferences ,actionBtnText ,routeData , handleOpenOverlay}) => {
