...
const TravelMS = ({ visible, setVisible, src }) => {
  ...
  return (
    ...
    visible && (
      ...
      <div className="fixed w-[100%] h-[100%] left-0 top-0  md:w-[80%] xl:w-[80%] md:h-[80%] lg:h-[80%] xl:h-[80%]   md:left-[10%] xl:left-[10%] blur-0  px-6 sm:px-0 md:rounded-b-lg shadow-lg z-30  bg-white ">
