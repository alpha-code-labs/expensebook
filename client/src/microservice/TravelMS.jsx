...
const TravelMS = ({ visible, setVisible, src }) => {
  ...
  return (
    ...
    visible && (
      ...
      <div className='fixed  w-[100%] h-[100%] left-0 top-0 bg-black/30  z-20'>

       </div>
      <div className="fixed w-[100%] backdrop-blur-sm h-[100%] left-0 top-0 md:w-[80%] md:h-[80%] md:left-[10%] blur-0 md:top-[10%] px-6 sm:px-0 sm:rounded-lg shadow-lg z-[100px] bg-white-100 ">
