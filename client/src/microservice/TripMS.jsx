...
const TripMS = ({ visible, setVisible, src }) => {
  ...
  return (
    ...
    visible && (
      ...
      <div className="fixed w-[100%] h-[100%] left-0 top-0  md:w-[80%] xl:w-[50%] md:h-[80%] lg:h-[80%] xl:h-[80%]   md:left-[10%] xl:left-[25%] blur-0 md:top-[5%] px-6 sm:px-0 sm:rounded-lg shadow-lg z-[100]  bg-white-100 ">
