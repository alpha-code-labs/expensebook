...
const TripMS = ({ visible, setVisible, src }) => {
  ...
  return (
    visible && (
      ...
      <div className="fixed w-[100%]  left-0 top-0  md:w-[80%] xl:w-[50%]  h-[100%]  md:left-[10%] xl:left-[25%] blur-0 px-6 sm:px-0 sm:rounded-b-lg shadow-lg z-[100]  bg-white shadow-black/50 ">
