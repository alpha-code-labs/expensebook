...
import SettlingAccountingEntriesforAllExpensesContainer from "../components/SettlingAccountingEntriesforAllExpenses/SettlingAccountingEntriesforAllExpensesContainer";
const SettlingAccountingEntriesforAllExpenses = () => {
  return (
    ...
    <div className="absolute top-[126px] left-[292px] flex flex-col items-start justify-start gap-[24px]">
     ...
     <SettlingAccountingEntriesforAllExpensesContainer />
    </div>
  <DashBoardProfile />
  <DashboardBellIcon />
  <DashboardOptions />
...
export default SettlingAccountingEntriesforAllExpenses