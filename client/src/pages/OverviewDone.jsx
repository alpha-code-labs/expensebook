  ...
  return (
    <div className="w-full border border-black min-h-screen flex items-center justify-center px-2 md:px-10">
      ...
      <div className={`min-w-[400px] h-[340px] ${visibleDivs[0] ? 'opacity-100' : 'opacity-0'}`} >
         ...
         <div className="h-[285px] overflow-y-auto mt-2 border-4 border-indigo-600 rounded-md px-2">
...
<div className={`min-w-[400px] h-[340px] transition-opacity delay-100 ${visibleDivs[2] ? 'opacity-100' : 'opacity-0'}`} >
        ...
        <div className="h-[288px]  overflow-y-auto   mt-2 border-4 border-indigo-600 rounded-md px-2">
          {trips.map((trip, index) => (
