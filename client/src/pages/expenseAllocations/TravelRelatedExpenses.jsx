...
const [headersUpdated, setHeadersUpdated] = useState(null)
    ...
    const saveTravelAllocationHeaders = async () => {
        ...
        .then(res => {
            console.log(res.data, '...res.data')
            res.status === 200 &&
            navigate(`/${tenantId}/expense-allocations/non-travel`, {state:{tenantId}})
        })
            ...
            <div className='px-6 py-10 bg-white rounded shadow w-full'>
                ...
                <div className='w-full flex flex-col gap-4'>  
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <div>
                            <HollowButton title='Skip' onClick={()=>navigate(`/${tenantId}/expense-allocations/non-travel`, {state:{tenantId}})} />
                        </div>
                    </div>
                ...
                <div className='p-10'>
                    ...
                    {selectedOrgHeaders.length===0 && <>
                        ...
                        <div className='flex justify-between items-center mt-6  '> 
                            <div className=''>
                                <Button text='Yes' onClick={()=>{navigate(`/${tenantId}/expense-allocations/non-travel`, {state:{tenantId}})}} />
                            </div>
                            <div>
