...
const [headersUpdated, setHeadersUpdated] = useState(null)
    ...
    const saveTravelAllocationHeaders = async () => {
        ...
        axios
        .post(`http://localhost:8001/api/tenant/${tenantId}/travel-expense-allocation`, {allocationHeaders})
        .then(res => {
            console.log(res.data, '...res.data')
            res.status === 200 &&
            navigate('/expense-allocations/non-travel', {state:{tenantId}})
        })
            ...
            <div className='px-6 py-10 bg-white rounded shadow w-full'>
                ...
                <div className='w-full flex flex-col gap-4'>  
                        ...
                        <div className='flex gap-4 items-center'>
                           <div className='cursor-pointer'>
                            ...
                            <p className='text text-xl font-cabin text-neutral-700'>
                                setup travel related expense allocations
                            </p>
                        </div>
                        <div>
                            <HollowButton title='Skip' onClick={()=>navigate('/expense-allocations/non-travel', {state:{tenantId}})} />
                        </div>
                    </div>
                  ...
                  { !readyToSelect && <>
                        ...
                        From the data you have provided, here is a list of entities to which you can allocate travel related expenses
                    </p>
                    ...
                    {readyToSelect &&                     
                        <>
                        <p className='text text-base font-cabin text-neutral-700'>
                            Select the entities you want to allocate travel related expenses to
                        </p>
                ...
                <div className='p-10'>
                    ...
                    {selectedOrgHeaders.length===0 && <>
                        ...
                        <div className='flex justify-between items-center mt-6  '> 
                            <div className=''>
                                <Button text='Yes' onClick={()=>{navigate('/expense-allocations/non-travel', {state:{tenantId}})}} />
                            </div>
                            <div>
