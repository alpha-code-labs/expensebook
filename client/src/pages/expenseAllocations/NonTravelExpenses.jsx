...
const [headersUpdated, setHeadersUpdated] = useState(null)
    ...
    const saveTravelAllocationHeaders = async () => {
        ...
        .then(res => {
            console.log(res.data, '...res.data')
            res.status === 200 &&
            navigate('/groups', {state:{tenantId}})
        })
            ...
            <div className='px-6 py-10 bg-white rounded shadow w-full'>
                ...
                <div className='w-full flex flex-col gap-4'>  
                    ...
                    <div className='flex justify-between items-center'>
                        ...
                        <div>
                            <HollowButton title='Skip' onClick={()=>navigate('/groups', {state:{tenantId}})} />
                        </div>
                    </div>
                  ...
                  { !readyToSelect && <>
                        ...
                        From the data you have provided, here is a list of entities to which you can allocate non-travel expenses
                    </p>
                ...
                <div className='p-10'>
                    ...
                    {selectedOrgHeaders.length===0 && <>
                        ...
                        <div className='flex justify-between items-center mt-6  '> 
                            <div className=''>
                                <Button text='Yes' onClick={()=>{navigate('/groups', {state:{tenantId}})}} />
                            </div>
                            <div>
