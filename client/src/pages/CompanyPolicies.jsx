      ...
      if (!groups) {
        ...
        if (state != null && state.groups != null && state.groups != []) {
          ...
          try {
            ...
            const policies_data_response = await axios.get(`http://localhost:8001/api/tenant/${tenantId}/policies`);
            ...
            if(!Array.isArray(policies)){
              ...
              //so user can setup only for newly added groups and still ad
