...
export default function (props){
    ...
    const [errors, setErrors] = useState({departureCitiesError:[{set:false, message:'Trip Purpose is required'}]},
                                           {departureCitiesError:[{set:false, message:'Trip Purpose is required'}]}  )
