...
if(travelBookingData){
  ...
  return (
    <>
      ...
      <div className="w-auto min-h-screen  flex flex-col lg:w-auto items-center px-2 lg:px-10    pt-[50px] bg-slate-100 ">
...
<div className='flex flex-col lg:flex-row  w-[220px] lg:w-[500px]  gap-4 mt-[25px] mx-11'>
    ...
    <div className="box-border mx-4 mt-[46px] w-auto max-w-[px]  h-px border-t-[1px] bg-white-100 border-b-gray "/>
    <div className=' h-auto max-h-[420px] overflow-auto   w-auto'>
