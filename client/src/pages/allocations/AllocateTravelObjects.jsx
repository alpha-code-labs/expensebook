...
export default function({addedItineraries, bookedItineraryIds, modifiedTripsIds, setAllocations, allocation,formData, setFormData, nextPage, lastPage, onBoardingData}){
    ...
    const handleSubmit = async()=>{
            ...
            const modifyTrip = {
                ...
                "cancelIds":[...bookedItineraryIds],
                "modifyIds":[...modifiedTripsIds],
                "newItinerary":addedItineraries,
                "allocations":selectedTravelAllocationHeaders
            }
            const res = await updateTravelRequest_API({tenantId,employeeId,tripId,tripDetails:modifyTrip})
            
            if(res.err){
                setPopupMessage(res.err)
                setTimeout(()=>{
