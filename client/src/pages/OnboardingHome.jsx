        ...
        <>
            ...
            <div className="flex bg-white w-full h-full overflow-x-hidden font-cabin tracking-tight">
                ...
                <div className='absolute left-0 w-[100%] px-4 pt-12 md:pt-0 md:px-0 md:left-[50%] md:w-[50%] top-0 overflow-x-hidden flex justify-center items-center'>
                    ...
                    <div className='flex flex-row-reverse mt-20 pr-4 md:pr-20'>
                        <div className='w-fit'>
