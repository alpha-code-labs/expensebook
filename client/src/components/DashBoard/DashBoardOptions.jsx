...
import { airplay, airplay1, airplay2, airplay3, circleOutline, frame505 } from "../../assets/icon.jsx";
      ...
      <div className="absolute top-[101px] left-[0px] flex flex-col items-start justify-start gap-[16px]">
        ...
        <div className="relative w-[244px] h-8 overflow-hidden shrink-0">
          <div className="absolute top-[calc(50% - 8px)] left-[32px] flex flex-row items-center justify-start gap-[8px]">
            <img className="relative w-4 h-4 overflow-hidden shrink-0" alt="" src={airplay} />
        ...
        <div className="relative w-[244px] h-8 overflow-hidden shrink-0">
          <div className="absolute top-[calc(50% - 8px)] left-[32px] flex flex-row items-center justify-start gap-[8px]">
            <img className="relative w-4 h-4 overflow-hidden shrink-0" alt="" src={airplay1} />
        ...
        <div className="relative w-[244px] h-8 overflow-hidden shrink-0">
          <div className="absolute top-[calc(50% - 8px)] left-[32px] flex flex-row items-center justify-start gap-[8px]">
            <img className="relative w-4 h-4 overflow-hidden shrink-0" alt="" src={airplay3} />
        ...
        <div className="relative bg-eb-primary-blue-50 w-[244px] h-8 overflow-hidden shrink-0 text-eb-primary-blue-500">
          <div className="absolute top-[calc(50% - 8px)] left-[32px] flex flex-row items-center justify-start gap-[8px]">
            <img className="relative w-4 h-4 overflow-hidden shrink-0" alt="" src={circleOutline} />
            <div className="relative font-medium" onClick={redirectToApprovals}>Approvals</div>
          </div>
        </div>
      </div>
