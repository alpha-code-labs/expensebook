    ...
    return (<>
        <div className="px-2 sm:px-4 py-3 rounded-xl bg-gray-200 border border-gray-400 flex gap-8 w-fit">
          <div className='relative flex items-center gap-4'>
              ...
              {isDropdownOpen && 
                <div ref={dropdownRef} className='z-[100] shadow-lg pt-4 flex flex-col items-center justify-center w-[150px] -left-[7%] top-[40px] absolute shadow-sm border-sm border-gray-400'>
