...
export default function Search(props){
    ...
    return(<>
        <div className="min-w-[100px] w-full max-w-[133px] h-[32px] flex-col justify-start items-start gap-2 inline-flex">
            ...
            <div
                ...
                <div className="text-neutral-700 w-full  h-full text-sm font-normal font-cabin">
                    <input
                        ...
                        className=" w-full h-full decoration:none px-6 py-.5 border rounded-md border border-neutral-300 focus-visible:outline-0 focus-visible:border-indigo-600 " 
                        value={textInput} 
