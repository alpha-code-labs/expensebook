...
export default function Modal(props){
   ...
   // const skipable = props.skipable || true
    ...
    return(
        <>
            {showModal && <div onClick={handleOutsideClick} className="fixed overflow-hidden z-[100] flex justify-center items-center inset-0 backdrop-blur-sm w-full h-full left-0 top-0 bg-gray-800/60 scroll-none">
