  ...
  return (
    ...
    <View className='w-full flex-col justify-start items-start gap-2'>
      ...
      <View className='w-full  h-[52px]  items-center flex'>
        <View className='relative bg-white     rounded-md w-[302px] h-full text-sm font-normal font-cabin flex items-center justify-between'>
          <TextInput
            ref={inputRef}
            autoFocus={autoFocus}
