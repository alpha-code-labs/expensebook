...
export default function (props){
   ...
   // const skipable = props.skipable || true
    ...
    return(
        <>
            {message !==null && <div onClick={handleOutsideClick} className="fixed overflow-hidden flex justify-center items-center inset-0 backdrop-blur-sm w-full h-full left-0 top-0 bg-gray-800/60 scroll-none">
