...
export default function Search(props){
    ...
    return(<>
        {visible && <div ref={ref} className="min-w-[300px] w-full max-w-[403px] h-[40px] flex-col justify-start items-start gap-2 inline-flex shadow-md">
            ...
            <div
                ...
                >
                    ...
                    filteredOptionsList.map((option, index) => (
                        <div key={index} className="flex gap-4 items-center pl-4 text-neutral-600 px-4 py-3 cursor-pointer transition-color hover:bg-gray-200 focus-visible:outline-0 focus-visible:bg-gray-100">
