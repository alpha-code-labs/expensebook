...
import { validation_sym, money } from '../../assets/icon';
  ...
  return (
    <div className="box w-full h-full  mb-2 font-cabin">
        ...
        {rejectedCashAdvance?.length > 0 ? (
          ...
          <div className="rounded-md h-full flex flex-col gap-4 self-stretch border  border-slate-300  items-center justify-center  text-sm">
          <img src={money} alt="NoTrip" className='A animate-pulse w-24 h-24'/>
          <h2 className='text-lg font-cabin text-neutral-600'>You don't have any Cash-Advances.</h2>
        </div>
        )}
...
// import { receipt, chevron_down, calender, double_arrow , three_dot ,validation_sym, down_left_arrow, money1, money} from '../../assets/icon';
...
// ))}
// </div>: 
// <div className='flex items-center justify-center border border-black h-[100%]'>
//   <img src={money} className='w-4 h-5'/>
// </div>}
// </div>
// </div>
//       </>
