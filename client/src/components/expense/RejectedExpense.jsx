...
import RejectedTravelExpense from './rejectedExpense/RejectedTravelExpense';
...
const AllExpense = ({handleTravelExpense ,handleNonTravelExpense}) => {
  ...
  return (
   ...
   <div className='flex flex-col px-2 py-3 gap-2'>
    ...
    <div className=' w-full h-[420px]   overflow-y-auto  border-gray-100 rounded-lg  '>
      <RejectedTravelExpense  travelExpense={travelExpense} handleTravelExpense={handleTravelExpense}/>
    </div>
    {/* <h2>Non Travel Expense</h2>
    <div className='  w-full h-[200px] overflow-y-auto border-[1px] border-gray-100 rounded-lg p-2 shadow-lg'>
      <RejectedNonTravelExpense  nonTravelExpense={nonTravelExpenses} handleNonTravelExpense={handleNonTravelExpense}/>
    </div> */}
  </div>
  </>
  )
