...
const RejectedNonTravelExpense = ({nonTravelExpense,handleNonTravelExpense}) => {
  return (
    <div className='h-full'>
    {nonTravelExpense.map((nonTravelExpenseDetails ,index)=>(
<>
...
{/* Trip Id */}
    <div className="flex w-auto  h-auto md:h-[52px] items-center justify-start min-w-[60px]   py-0 md:py-3 px-2 order-1 gap-2">
    
     <div className=" text-[14px] tracking-[0.02em]  font-bold  md:text-[12px] text-left  leading-normal text-neutral-800 font-cabin ">
      {nonTravelExpenseDetails.expenseHeaderId}
     </div>
    </div> 
{/* Trip Title */}
    <div className="group flex h-[52px] relative   items-center justify-start [210px]  xl:w-[200px] lg:[100px] py-0 md:py-3 px-2 order-1 gap-2">
      ...
      {nonTravelExpenseDetails.category}
...
{/* <div className='flex flex-1 justify-center items-end gap-4 py-2 px-3'>
       ...
       <div  className='flex cursor-pointer items-center justify-center w-6 h-6 bg-purple-50 rounded-full ' onClick={()=>urlRedirection(MODIFY_NON_TRAVEL_EXPENSE)}>
    ...
    {/* <div className="flex flex-none w-[40px] py-3  cursor-pointer items-end justify-center lg:items-center relative">
      ...
      <div onClick={()=>handleNonTravelExpense(nonTravelExpenseDetails.expenseHeaderId,"non-tr-ex-clear-rejected")} className="flex-1 flex items-center justify-end py-2 px-3 cursor-pointer">
...
export default RejectedNonTravelExpense
