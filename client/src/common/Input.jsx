...
export default function Input(props) {
    ...
    return (
        <div className={`${showLocationSymbol ? 'min-w-[184px]' : 'min-w-[200px]'} w-full md:w-fit  h-[73px] flex-col justify-start items-start gap-2 inline-flex`}>
            {/* title */}
            ...
            <div className="relative w-full h-full bg-white items-center flex">
                <div className="relative text-neutral-700 w-full h-full text-sm font-normal font-cabin">
                    <input
                        ...
                        onBlur={handleBlur}
                        className={`w-full h-full decoration:none ${showLocationSymbol ? 'pr-6 pl-12' : 'px-6'} py-2 border rounded-md border-neutral-300 w-full focus-visible:outline-0 focus-visible:border-indigo-600`}
                        value={textInput}
